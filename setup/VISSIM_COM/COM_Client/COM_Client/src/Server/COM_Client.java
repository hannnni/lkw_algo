...
public class COM_Client {
	...
	/**
	 * Thread für das Empfangen der Daten der Detectionen bzw. der minütliche Empfangen der auf Stundenwerte extrapolierten Verkehrsstäken
	 * Übertragung zeitschrittorientiert sekündlich
	 */
	...
	/**
	 * Thread für das Empfangen der Daten über die sich geänderten Status der LSA-Anzeigen
	 * Übertragung ereignisorientiert bei Änderung 
	 */
	...
	private static void schreibeDaten_Detection(Object o_Detection)
	{
	    ...
	    Wenn auf der Stelle 0 eine 9999 kommt ist die Simulation beendet. Die Threats müssen gestoppt und das Programm beendet werden
